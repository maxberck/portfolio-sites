...
export const siteCategories: SiteCategoryDefinition[] = [
  {
    ...
    description: "Réparation, entretien, diagnostic et dépannage : quatre directions de garage avec des identités visuelles volontairement différentes.",
  },
  {
    id: "restaurant",
    label: "Restaurant",
...
export const portfolioSites: PortfolioSite[] = [
  {
    ...
    name: "Atelier Noir",
    category: "garage",
    direction: "Réparation premium",
    summary: "Direction prévue : entretien, réparation et diagnostic dans un univers automobile cinématographique, sombre et très espacé.",
  ...
  },
  {
    ...
    name: "Torque Works",
    category: "garage",
    direction: "Réparation / mécanique",
    summary: "Direction prévue : réparation mécanique, gros entretien et diagnostic technique dans une grille d’atelier industrielle et utilitaire.",
  ...
  },
  {
    ...
    summary: "Direction prévue : entretien performance, mise au point et diagnostic avec typographie condensée, compositions diagonales et cadrages de piste serrés.",
  ...
  },
  {
    ...
    summary: "Direction prévue : dépannage, entretien courant et service atelier dans une mise en page éditoriale blanche, claire et très fonctionnelle.",
